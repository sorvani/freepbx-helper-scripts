...
Reads a Contact Manager group and outputs it as a Fanvil Remote Address Book XML document.

Unlike the Yealink format, the number type is the tag name itself
(`<Mobile>555…</Mobile>`) rather than a label attribute.
